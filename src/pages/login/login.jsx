            ...
            <div className={'login-container'}>
                ...
                {this.state.loginWay ? <form className="login-form">
                        <section className="input-container phone-number">
                            <input type="text" placeholder="账户密码随便输入" name="phone" maxLength="11"
                    ...
                    <form className="login-form">
                        ...
                        <section className='input-container'>
                            {this.state.showPwd ? <input type="text" placeholder='密码' value={this.state.password}
                            ...
                            <div className={`button-switch ${this.state.showPwd ? 'change-to-text' : ''}`}>
                                <div className={`circle-button ${this.state.showPwd ? 'trans_to_right' : ''}`}
                                     onClick={this.changePasswordType.bind(this)}></div>
                                <span>abc</span>
                                <span>...</span>
                            </div>
                        </section>
                ...
                {this.state.hasAlert && <AlertTip logout={() => {
                    return false
                }} closeTip={this.closeTip} alertText={this.state.alertText}/>}
            </div>
        );
    }
