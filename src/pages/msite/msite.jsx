...
import "./msite.scss";
import API from "../../api";
import {fromJS, is} from 'immutable'; // 保证数据的不可变
import Swiper from "swiper/dist/js/swiper.js";
import "swiper/dist/css/swiper.css";
import {saveAttrInfo} from '../../store'
...
class Msite extends Component {
    ...
    getFoodTypes = async () => {
        ...
        this.setState({footTypes: foodArr})
                                        ...
                                        {foodItem.map((item, index) => {
                                            return (
                                                <Link className="link-to-food"
                                                      to={`/food/${this.state.geohash}/${this.getCategoryId(item.link)}/${item.title}`}
                                                      key={index}>
                                                    <figure>
                                                        <img
