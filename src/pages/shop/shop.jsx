                            ...
                            <li key={index}>
                                <header className='menu-detail-header'>
                                    <div className="menu-detail-header-left">
                                        ...
                                        <span
                                            className="menu-item-description">{item.description}</span>
                                    </div>
                                        ...
                                        <div className='menu-detail-list' key={foodIndex}>
                                            ...
                                            <footer className='menu-detail-footer'>
                                                ...
                                                <div className='add-del-icon'>
                                                    <div className='icon-wuuiconsuoxiao'
                                                         onClick={this.handleAddFoodCount.bind(this, food.num, -1)}></div>
        ...
        return (
            <div className="shop-container">
                ...
                <header className="shop-detail-header">
                    <img
                        src={this.state.imgUrl + this.state.shopDetailData.image_path}
                        alt=""
                ...
                <div className='change-show-type'>
                    <div><span onClick={this.changeShowType.bind(this, 'food')}
                               className={this.state.active === 'food' ? 'activity-show' : ''}>商品</span></div>
                    <div><span onClick={this.changeShowType.bind(this, 'rating')}
                               className={this.state.active === 'rating' ? 'activity-show' : ''}>评价</span></div>
                </div>
                    ...
                    <div className="menu-left">
                        <ul>
                            {this.state.menuList ? this.state.menuList.map((item, index) => {
                                return (
                                    <li className={this.state.activeIndex === index ? 'activity-menu menu-left-li' : 'menu-left-li'}
                                        key={index} onClick={this.activeMenu.bind(this, index)}>
                ...
                <div className="buy-cart-container">
                    <div className='cart-icon-num'>
                        <div onClick={this.handleShowCart}
                    ...
                    <div onClick={this.handleClick.bind(this, 'unfinished')}
                                    ...
                                    (
                                        <li className='cart-food-li' key={index}>
                                            ...
                                            <div className='cart-list-control'>
                                                <div className='icon-wuuiconsuoxiao'
                                                     onClick={this.handleAddFoodCount.bind(this, cart.num, -1)}></div>
                                                <div>{cart.qty}</div>
                                                <div className='icon-wuuiconxiangjifangda'
                                                     onClick={this.handleAddFoodCount.bind(this, cart.num, 1)}></div>
                                            </div>
                ...
                {
                    this.state.hasAlert && <AlertTip logout={() => {
                        return false
                    }} closeTip={this.handleClick} alertText={this.state.alertText}/>
                }
            </div>
        );
    }
